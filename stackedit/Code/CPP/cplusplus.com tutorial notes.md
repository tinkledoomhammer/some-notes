...
`.seekg(streamoff seekdir)` and `.seekp(streamoff, seekdir);` 
...
* `ios::pos_type` is `std::streampos` which can be added, subtracted, and converted to/from `streamoff`
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY3ODM2ODg3NF19
-->