...
fn main() {
	...
	let mut_borrow = || list2.push(4);
	let moves = move || println!("From another thred: {list3:?}");
...
Release profiles
: predefined, customizable profiles with diffferent configurations that allow a programmer to have more control over various options for compiling code
: Each profile is configured independently
...
: deprecate that version
: add `--undo` to reverse the decision
: will not break projects that already have that version in their `cargo.lock`
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODk4ODg0MDc0LC0xODY1NjkxNDg4LC00NT
IwMjcxOCwtMTg5NjY3MzcxMSwxMzcxNDI2MDU5LC0xOTc2OTEw
NTkxLDEzNTU0OTkxODAsMTcxMTMxODEzNCwxMzE1NDY0MTM0LD
EzMTU0NjQxMzQsLTQwNjI1MDgzMCw3MDg2NTg0NzcsMjEyMjA2
NjQ5Niw5NDYzOTk3OTksLTE1MzQ3MDk4MDYsOTEyNTIyNDE3LC
00NTc2NzMyMDMsLTM2MTgyODc5NSwtNjQ0MzEwMjQ1LC0xNDUz
ODE4MDE5XX0=
-->